...
describe 'Assertions' do # rubocop:disable Metrics/BlockLength
...
describe 'Expection' do # rubocop:disable Metrics/BlockLength
  it 'should be true' do
    var = true
...
class MyTest < Minitest::Test
  ...
  def setup # rubocop:disable Lint/DuplicateMethods
    puts 'b'
  end
  ...
  def teardown # rubocop:disable Lint/DuplicateMethods
    puts 'e'
  end
